...
label = tkinter.Label(frame, text=curr_player+"'s turn", font=("Consolas", 30), background=color_gray,
                      foreground="white")
...
restart_button = tkinter.Button(frame, text="Restart", font=("Consolas", 18), background=color_gray,
